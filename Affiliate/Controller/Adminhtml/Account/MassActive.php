...
class MassActive extends Action
{
    ...
    protected $filter;
    const ADMIN_RESOURCE = 'Mageplaza_Affiliate::manageaccount_massactive';
    ...
    public function execute()
    {
        ...
        foreach ($collection as $model) {
            $model->addData(['status' => 1])->save();
            $count++;
        }
        $this->messageManager->addSuccess(__('A total of %1 Account have been active.', $count));
